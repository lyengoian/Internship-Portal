			...
			<div class="formdiv">
				...
				<label for="location_name">Location:<span class="text-danger">*</span></label>				
					<select name="location_name" id="location_name">
						...
						<div class="formdivdiv"><label for="location_name_other">If other, please specify:</label></div>
						<input type="text" id="location_name_other" name="location_name_other">
			...
			<div class="formdiv">
				...
				<label for="role_title">Role:<span class="text-danger">*</span></label>			
					<select name="role_title" id="role_title">
					    ...
					    <div class="formdivdiv"><label for="role_title_other">If other, please specify:</label></div>
						<input type="text" id="role_title_other" name="role_title_other">
